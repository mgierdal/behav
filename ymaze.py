...
# Copyright (C) Marcin Gierdalski 2020
...
def is_data_valid(data):
    """check if field 'entries' contains only 3 symbols

    arguments:
    data - entries (string of 3 symbols)
...
def get_alternations(data):
    """return list of all alternations
